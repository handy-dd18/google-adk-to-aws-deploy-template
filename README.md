...
Google ADKを利用してAWS上にAIアプリケーションを構築するテンプレート

## 目的
Google ADKで構築したマルチエージェントAIアプリを、AWSのマネージドサービス中心（常時稼働サーバーなし）で動かすための設計・実装ガイドです。
...
- [ ] フェーズ2: Google ADKのマルチエージェント骨組みを実装
